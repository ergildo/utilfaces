if (window.PrimeFaces) {
	PrimeFaces.locales['pt_BR'] = {
		...
		messages : {
			...
			'javax.validation.constraints.Digits.message' : 'Valor num\u00E9rico fora do limite (<{0} d\u00EDgitos>.<{1} d\u00EDgitos> esperado)',
			...
			'javax.validation.constraints.Pattern.message' : 'Deve corresponder \u00E0 "{0}"',
